...
<head>
    ...
    <style>
        ...
        .metric .value.small{font-size:16px;line-height:1.8;word-break:break-word}
        ...
        .btn{display:inline-block;text-decoration:none;padding:10px 16px;border-radius:12px;background:#111827;color:#fff}
        .flag{padding:10px 12px;border-radius:12px;margin-bottom:8px}
...
<div class="wrap">
    ...
    <?php else: ?>
        <div class="card">
            ...
            <p>
                <span class="badge" style="<?= e(resultBadgeStyle((string)$submission['category'])) ?>">
                    <?= e((string)($submission['category_label'] ?? studyCategoryLabel((string)$submission['category']))) ?>
                </span>
                &nbsp;
                ...
                <span class="badge" style="background:#dcfce7;color:#166534;">
                    قرار اللجنة: <?= e(committeeStatusLabel((string)($submission['committee_status'] ?? 'pending'))) ?>
                </span>
            </p>
        ...
        <div class="card">
            <h2 class="section-title">الإقرار والموقع والعنوان</h2>
            <div class="grid">
                <div class="metric">
                ...
                <div class="metric">
                    ...
                    <div class="value small"><?= e($mapsLink !== '' ? $mapsLink : '-') ?></div>
                </div>
            </div>
        </div>
